...
export default function DashboardPage() {
    ...
    const quickActions = [
        ...
        },
        {
            ...
            href: "https://www.bamis.gov.bd/", // Bangladesh Agrometeorological Information System
            ...
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div className="grid gap-6 lg:grid-cols-3 items-start">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Crop Registration moved here to stack directly under Weather */}
                    ...
                    {/* Bottom CTA */}
                    <div className="lg:col-span-3 rounded-2xl bg-gradient-to-r from-emerald-600 to-emerald-700 p-8 text-center shadow-lg">
